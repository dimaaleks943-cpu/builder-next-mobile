...
import { parseCssUrl, toCssBackgroundUrlValue } from "../utils/backgroundImageLayersUtils.ts"
import {
...
export const UrlFillEditorSection = ({
  backgroundImage,
  backgroundSize,
  backgroundPosition,
  backgroundRepeat,
  ...
  const previewHref = parseCssUrl(backgroundImage)
  ...
  const handleApplyImageUrl = () => {
    ...
    if (!trimmed) return
    onCommitBackgroundImage(toCssBackgroundUrlValue(trimmed), { urlFillDefaults: "apply" })
    setImageUrlPopperAnchor(null)
  }
        ...
        <MenuRow>
          ...
          <PositionBlock>
            <BackgroundPositionNineGrid
              positionPair={joinBackgroundPositionDimensions(positionDims.x, positionDims.y)}
              onCommitPair={onCommitBackgroundPosition}
            />
            <PositionInputsColumn>
              <InsetAxisRow>
