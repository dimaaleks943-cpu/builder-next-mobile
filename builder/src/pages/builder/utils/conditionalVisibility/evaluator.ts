...
const toComparableNumber = (value: ConditionalVisibilityValue | undefined): number | null => {
...
const toComparableString = (value: ConditionalVisibilityValue | undefined): string => {
...
const evaluateCondition = (
  ...
  if (condition.operator === "greaterThan") {
    ...
    return sourceNumber !== null && operandNumber !== null && sourceNumber > operandNumber
  }
...
export const evaluateConditionalVisibility = (params: {
  ...
  const config: ConditionalVisibilityConfig = normalizeConditionalVisibilityConfig(params.rawConfig)
  ...
  const sortedGroups = [...config.groups].sort((left, right) => left.priority - right.priority)
