import { getVariableById } from "./designVariablesRegistry.ts"
import { isStyleVariableRef } from "./types.ts"
...
export const resolveDesignVariableRefs = (
  ...
  for (const [key, value] of Object.entries(resolved)) {
    ...
    if (variable.type === "color" || variable.type === "size" || variable.type === "fontFamily") {
